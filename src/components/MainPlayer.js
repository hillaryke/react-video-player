...
const playIconButton = () => {
   return (
       <div id="playButton" className="hover:opacity-50 transition ease-in-out duration-500 hover:cursor-pointer absolute p-7 bg-gray-200 h-[90px] w-[90px] rounded-[100px]"  >
